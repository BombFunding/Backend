    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startup_applicant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authenticator.startupprofile')),
            ],
        ),
        migrations.CreateModel(
            name='StartupComment',
            fields=[
                ...
                ('startup_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authenticator.startupprofile')),
