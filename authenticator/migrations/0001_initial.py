    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('startup', 'Startup'), ('basic', 'Basic')], default='basic', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_user', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='profile', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
